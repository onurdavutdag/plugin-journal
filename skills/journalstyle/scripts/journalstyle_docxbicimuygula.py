...
Kullanım:
    python journalstyle_docxbicimuygula.py <girdi.docx> <profil.json> <cikti.docx> [--add-sections]
...
def _existing_headings(doc):
    """Belgedeki başlık metinleri — journalstyle_docxyapicikar.py ile AYNI kural."""
