#!/usr/bin/env python3
# Adapted from k-dense-ai/scientific-agent-skills/skills/pptx-posters/scripts/check_layout.py, MIT, K-Dense Inc. Renamed to this package's N12 rule; imports re-pointed; nothing else changed.
...
from journalsunum_ortak import CliError, emit_json
from journalsunum_manifestyukle import load_and_validate_manifest
from journalsunum_pptxokuyaz import analyze_layout
