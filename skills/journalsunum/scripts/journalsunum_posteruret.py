#!/usr/bin/env python3
# Adapted from k-dense-ai/scientific-agent-skills/skills/pptx-posters/scripts/generate_poster.py, MIT, K-Dense Inc. Renamed to this package's N12 rule; imports re-pointed; nothing else changed.
...
from journalsunum_ortak import (
    CliError,
    checked_output_file,
    commit_temp_file,
    emit_json,
...
from journalsunum_gorseltara import build_inventory
