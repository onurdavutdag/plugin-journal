#!/usr/bin/env python3
# Adapted from k-dense-ai/scientific-agent-skills/skills/pptx-posters/scripts/_pptx.py, MIT, K-Dense Inc. Renamed to this package's N12 rule; imports re-pointed; nothing else changed.
