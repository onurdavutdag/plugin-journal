#!/usr/bin/env python3
# Adapted from k-dense-ai/scientific-agent-skills/skills/pptx-posters/scripts/inventory_images.py, MIT, K-Dense Inc. Renamed to this package's N12 rule; imports re-pointed; nothing else changed.
...
from journalsunum_ortak import CliError, emit_json, resolve_local_asset
from journalsunum_manifestyukle import ASSET_SUFFIXES, load_and_validate_manifest
