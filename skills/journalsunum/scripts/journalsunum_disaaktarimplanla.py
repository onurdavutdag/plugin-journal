...
def build_export_plan(
    ...
    manual_actions.extend(
        [
            "Run journalsunum_pptxincele.py, journalsunum_yerlesimdenetle.py, journalsunum_gorseltara.py, and journalsunum_paletdenetle.py on the final source package.",
