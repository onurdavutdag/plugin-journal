#!/usr/bin/env python3
# Adapted from k-dense-ai/scientific-agent-skills/skills/pptx-posters/scripts/check_palette.py, MIT, K-Dense Inc. Renamed to this package's N12 rule; imports re-pointed; nothing else changed.
...
from journalsunum_ortak import CliError, contrast_ratio, emit_json, parse_hex_color, relative_luminance
from journalsunum_manifestyukle import load_and_validate_manifest
