...
Usage:
    python search_pdfs.py --dir <workspace-or-project-dir> --terms "phrase one" "keyword" ...
    python search_pdfs.py --dir . --terms "postoperative delirium" dexmedetomidine --context 240
