...
Usage:
    python pubmed_eutils.py --query "dexmedetomidine postoperative delirium" --retmax 5
    python pubmed_eutils.py --pmid 34567890            # fetch one record's metadata
    python pubmed_eutils.py --doi 10.1001/jama.2019.4783  # resolve a DOI to a PMID/record
